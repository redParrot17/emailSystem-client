...
public class HybridCryptography {
     ...
     */
    public static EncryptionPacket generateEncryptionPacket(String message, EncryptionPacket.PacketType packetType, PublicKey publicKey, PrivateKey privateKey) {
     ...
     * @param publicKey  the {@link PublicKey} used to validate the author
     * @param privateKey the {@link PrivateKey} used for the decryption
     * @return           the original decrypted data
     * @throws Exception
     */
    public static String decryptEncryptionPacket(EncryptionPacket packet, PublicKey publicKey, PrivateKey privateKey) throws Exception {
